 ...
 */
public class RoundImagview extends ImageView {
        ...
        public RoundImagview(Context context, AttributeSet attrs) {
            super(context, attrs);
            mContext = context;
            setCustomAttributes(attrs);
        }

        public RoundImagview(Context context, AttributeSet attrs, int defStyle) {
